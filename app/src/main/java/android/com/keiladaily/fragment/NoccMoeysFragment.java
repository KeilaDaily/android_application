 ...
 * {@link NoccMoeysFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NoccMoeysFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NoccMoeysFragment extends Fragment {
    ...
    public static NoccMoeysFragment newInstance(String param1, String param2) {
        NoccMoeysFragment fragment = new NoccMoeysFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView = inflater.inflate(R.layout.fragment_noccmoeys, container, false);
...
//        }
    ...
    private class GetJasons extends AsyncTask<Void, Void, Void> {
        ...
        private List<User> bindToListFootball(){
            ...
            // Jason Data
            String url = getString(R.string.url) + "ContentAll/ShowContentByCategory/4?amount=10";
        ...
        private String getJasonArrayAllContect(){
            ...
            // Jason Data
            String url = getString(R.string.url) + "/ContentAll/ShowContentByCategory/4";
            JasonData jason = new JasonData();
    ...
    class UserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                View view = LayoutInflater.from(myFragmentView.getContext()).inflate(R.layout.layout_loading_item, parent, false);
