 ...
 * {@link BoxingFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BoxingFragment#newInstance} factory method to
...
public class BoxingFragment extends Fragment {
    ...
    public static BoxingFragment newInstance(String param1, String param2) {
...
//        }
    ...
    private class GetJasons extends AsyncTask<Void, Void, Void> {
        ...
        private List<User> bindToListFootball(){
            ...
            User user = new User();
            // Jason Data
            String url = getString(R.string.url) + "ContentAll/ShowContentByCategory/3?amount=10";
        ...
        private String getJasonArrayAllContect(){
            ...
            // Jason Data
            String url = getString(R.string.url) + "/ContentAll/ShowContentByCategory/3";
            JasonData jason = new JasonData();
