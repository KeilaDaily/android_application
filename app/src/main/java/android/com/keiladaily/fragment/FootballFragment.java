...
public class FootballFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView = inflater.inflate(R.layout.fragment_football, container, false);
...
//        }
    ...
    private class GetJasons extends AsyncTask<Void, Void, Void> {
        ...
        private List<User> bindToListFootball(){
            ...
            User user = new User();
            // Jason Data
            String url = getString(R.string.url) + "ContentAll/ShowContentByCategory/2?amount=10";
        ...
        private String getJasonArrayAllContect(){
            ...
            // Jason Data
            String url = getString(R.string.url) + "/ContentAll/ShowContentByCategory/2";
            JasonData jason = new JasonData();
