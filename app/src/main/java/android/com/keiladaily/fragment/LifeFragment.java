...
public class LifeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView = inflater.inflate(R.layout.fragment_life, container, false);
...
//        }
    ...
    private class GetJasons extends AsyncTask<Void, Void, Void> {
        ...
        private List<User> bindToListFootball(){
            ...
            User user = new User();
            // Jason Data
            String url = getString(R.string.url) + "ContentAll/ShowContentByCategory/6?amount=10";
        ...
        private String getJasonArrayAllContect(){
            ...
            // Jason Data
            String url = getString(R.string.url) + "/ContentAll/ShowContentByCategory/6";
            JasonData jason = new JasonData();
